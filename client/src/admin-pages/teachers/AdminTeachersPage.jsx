...
export const AdminTeachersPage = () => {
  ...
  const handleSortTeachers = (criteria) => {
    setSort(criteria);
    if (activePage !== 1) {
      setActivePage(1);
      setOffset(0);
  ...
  const handleFilterTeachers = (criteria) => {
    setSort(SORT_OPTIONS[0]);
    if (activePage !== 1) {
      setActivePage(1);
      setOffset(0);
              ...
              <Form.Row>
                <Col md="4" className="d-flex">
                  ...
                  <Form.Control
                    as="select"
                    value={sort}
                    onChange={(opt) => handleSortTeachers(opt.target.value)}
                  >
                    {SORT_OPTIONS.map((so) => (
                ...
                <Col md="8" className="d-flex">
                  ...
                  <Form.Control
                    onChange={(str) =>
                      handleFilterTeachers(String(str.target.value))
                    }
                    placeholder="Buscar..."
                    type="text"
                    ref={searchRef}
