...
// matches with /guestapi/fetchSchoolDropdownItems
...
// matches with /guestapi/fetchCoursesBySchool/:school/:studentId
...
// matches with /guestapi/fetchCourses
router.get("/fetchLandingPageCourses", function (req, res) {
  model.Course.find({ isActive: true })
