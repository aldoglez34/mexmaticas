...
const {
  generateDefaultExams,
  getNextTopicOrderNumber,
} = require("../utils/helpers");

// fetchTopic()
// matches with /adminapi/topics/:courseId/:topicId
...
// matches with /adminapi/topics/difficulties/:courseId/:topicId
...
// updateTopicName()
// matches with /adminapi/topics/update/name
...
// updateTopicSubject()
// matches with /adminapi/topics/update/subject
...
// matches with /adminapi/topics/update/description
...
// matches with /adminapi/topics/update/timer
...
// newTopic()
// matches with /adminapi/topics/new
router.put("/new", async (req, res) => {
  ...
  try {
    ...
    const nextTopicOrderNumber = getNextTopicOrderNumber(topics);

    // generate data for 5 exams, one for each difficulty for the new topic
    const defaultExams = generateDefaultExams(topicName);
...
// updateTopicOrder()
// matches with /adminapi/topics/update/order
...
// deleteTopic()
// matches with /adminapi/topics/delete
